                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-3 sm:px-4 py-2 bg-gray-50 border text-gray-700 border-gray-200 rounded-lg text-sm sm:text-base"
                    />
                  </div>
                  ...
                  {/* Verification */}
                  <div className="md:col-span-2 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mt-2">
                    <span
